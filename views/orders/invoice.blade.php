                ...
                <table class="table table-bordered">
                    ...
                    @foreach($model->getOrderMenus() as $menuItem)
                        <tr>
                            ...
                            <td>
                             @if($menuItem->uom_tag != '')
                                {{ isset($menuItem->actual_amt) ? number_format($menuItem->actual_amt, $menuItem->uom_decimals) : number_format($menuItem->quantity, $menuItem->uom_decimals)  }}&nbsp;{{ $menuItem->uom_tag }}
                            @else
                                {{ isset($menuItem->actual_amt) ? number_format($menuItem->actual_amt, 0) : number_format($menuItem->quantity, 0) }}
                            @endif
                            </td>
